	...
	<div id="app">
		<v-app id="test-service">
			<div class="header" v-if="isLoggedIn">
				<div class="header__logo font-weight-light">
				...
				<div class="header__admin" v-if="isAdmin">
					<v-btn outlined @click="goToAdminPanel" dark>
						<v-icon>mdi-settings</v-icon> Панель администратора
					</v-btn>
				</div>
				<div class="header__exit">
					<v-btn @click="logout" v-if="!isActiveSession" outlined dark>
